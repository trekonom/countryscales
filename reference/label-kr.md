...
The label_xxx_kr family of functions makes it easy to format numbers in
...
label_number_kr()(c(-1e6, 0, 1e6))
#> [1] "-1,000,000" "0"          "1,000,000" 
label_percent_kr(accuracy = .01)(c(-1, 0, 1))
#> [1] "-100.00%" "0.00%"    "100.00%" 
label_currency_kr(accuracy = .1)(c(-1e6, 0, 1e6))

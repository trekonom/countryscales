...
The label_xxx_br family of functions makes it easy to format numbers in
...
label_number_br()(c(-1e6, 0, 1e6))
#> [1] "-1.000.000" "0"          "1.000.000" 
label_percent_br(accuracy = .01)(c(-1, 0, 1))
#> [1] "-100,00%" "0,00%"    "100,00%" 
label_currency_br(accuracy = .1)(c(-1e6, 0, 1e6))
#> [1] "-R$ 1.000.000,0" "R$ 0,0"          "R$ 1.000.000,0" 
```

...
The label_xxx_no family of functions makes it easy to format numbers in
...
label_number_no()(c(-1e6, 0, 1e6))
#> [1] "−1 000 000" "0"          "1 000 000" 
label_percent_no(accuracy = .01)(c(-1, 0, 1))
#> [1] "−100,00 %" "0,00 %"    "100,00 %" 
label_currency_no(accuracy = .1)(c(-1e6, 0, 1e6))
#> [1] "kr −1 000 000,0" "kr 0,0"          "kr 1 000 000,0" 
```

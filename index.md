...
Here’s an example showing how 1 million USD are formatted in the G20
countries:
...
![](reference/figures/README-locale-g20-1.png)
...
![](reference/figures/README-locale-de-1.png)
...
![](reference/figures/README-locale-ch-1.png)
...
- Last but not least thanks to the authors of the
  ...
  - Second, I learend that minus signs, percent signs, … include
    ...
    Hence, under the hood `countryscales` uses a modified version of
    `label_number` to (mainly) account for Unicode control characters.

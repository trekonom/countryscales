...
#' @name scale-at
#'
#' @example inst/ex/ex-scale-at.R
NULL

#' @rdname scale-at
#' @export
scale_x_number_at <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-at
#' @export
scale_x_percent_at <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-at
#' @export
scale_x_currency_at <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,
...
#' @rdname scale-at
#' @export
scale_y_number_at <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-at
#' @export
scale_y_percent_at <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-at
#' @export
scale_y_currency_at <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,

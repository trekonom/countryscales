...
#' @name scale-za
#'
#' @example inst/ex/ex-scale-za.R
NULL

#' @rdname scale-za
#' @export
scale_x_number_za <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-za
#' @export
scale_x_percent_za <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-za
#' @export
scale_x_currency_za <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,
...
#' @rdname scale-za
#' @export
scale_y_number_za <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-za
#' @export
scale_y_percent_za <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-za
#' @export
scale_y_currency_za <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,

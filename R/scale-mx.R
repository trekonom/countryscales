...
#' @name scale-mx
#'
#' @example inst/ex/ex-scale-mx.R
NULL

#' @rdname scale-mx
#' @export
scale_x_number_mx <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-mx
#' @export
scale_x_percent_mx <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-mx
#' @export
scale_x_currency_mx <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,
...
#' @rdname scale-mx
#' @export
scale_y_number_mx <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-mx
#' @export
scale_y_percent_mx <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-mx
#' @export
scale_y_currency_mx <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,

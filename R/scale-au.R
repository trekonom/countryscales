...
#' @name scale-au
#'
#' @example inst/ex/ex-scale-au.R
NULL

#' @rdname scale-au
#' @export
scale_x_number_au <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-au
#' @export
scale_x_percent_au <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-au
#' @export
scale_x_currency_au <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,
...
#' @rdname scale-au
#' @export
scale_y_number_au <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-au
#' @export
scale_y_percent_au <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-au
#' @export
scale_y_currency_au <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,

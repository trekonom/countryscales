...
#' @name scale-cn
#'
#' @example inst/ex/ex-scale-cn.R
NULL

#' @rdname scale-cn
#' @export
scale_x_number_cn <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-cn
#' @export
scale_x_percent_cn <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-cn
#' @export
scale_x_currency_cn <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,
...
#' @rdname scale-cn
#' @export
scale_y_number_cn <- function(name = waiver(),
                              breaks = waiver(),
                              minor_breaks = waiver(),
                              guide = waiver(),
                              n.breaks = NULL,
...
#' @rdname scale-cn
#' @export
scale_y_percent_cn <- function(name = waiver(),
                               breaks = waiver(),
                               minor_breaks = waiver(),
                               guide = waiver(),
                               n.breaks = NULL,
...
#' @rdname scale-cn
#' @export
scale_y_currency_cn <- function(name = waiver(),
                                breaks = waiver(),
                                minor_breaks = waiver(),
                                guide = waiver(),
                                n.breaks = NULL,
